  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className="w-full px-4 py-2 text-sm text-zinc-900 bg-white/80 backdrop-blur-sm rounded-lg
          border border-zinc-200/50 outline-none focus:ring-2 ring-zinc-400 transition-all
