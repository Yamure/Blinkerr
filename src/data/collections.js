...
export const collections = {
  ...
  Resources: [
    ...
    },
    {
      ...
      dateAdded: "2024-01-15",
      useCase: "An easy way to speed up development of React applications.",
      comments:
    ...
    },
    {
      ...
      comments: "The portfolios are well-structured and easy to navigate.",
    },
    {
      id: uuidv4(),
      title: "ShadCN",
  ...
  Learning: [
    {
      ...
      dateAdded: "2025-02-09",
      useCase: "Perfect for learning about security concepts and techniques.",
      comments:
  ...
  Libraries: [
    {
      ...
      category: "Libraries",
      description: "A Javascript library for handling keyboard shortcuts.",
      dateAdded: "2024-01-15",
      useCase: "Perfect for handling keyboard shortcuts in web applications.",
